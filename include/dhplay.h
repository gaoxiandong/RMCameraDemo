...
//		need to get data from the file, you?ˉe better get from I frame. But the end postion does not matter
...
//				pFramePos,I frame position information struct pointer.,?ê??PFRAME_POS.
// Returns:		BOOL,TRUE--succeeded FALSE--failed.
//------------------------------------------------------------------------
...
/* Function: PLAY_SetEngine
   ...
   Return: BOOL, successful return to TRUE, failed return to FALSE.   
   Example：if only set one Decode Engine，can set Render Engine With NONE,
